                                        ...
                                        <div class="flex-col show-for-medium flex-left">
                                                <ul class="mobile-nav nav nav-left ">
                                                        <li class="nav-icon has-icon">
                                                                <a href="#" data-open="#main-menu" data-pos="center"
                                                                        data-bg="main-menu-overlay" data-color="dark"
                                                                        class="is-small" aria-label="Menu"
                                                                        aria-controls="main-menu" aria-expanded="false">
                                                                        <i class="icon-menu"></i>
                                                                        <span
                                                                                class="menu-title uppercase hide-for-small">Menu</span>
                                                                </a>
                                                        </li>
                                                        <li
                                                                class="header-search header-search-dropdown has-icon has-dropdown menu-item-has-children">
                                                                <a href="#" aria-label="Ara" class="is-small"><i
                                                                                                        ...
                                                                                                        <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                        ...
                                                                                                                        <label class="screen-reader-text"
                                                                                                                                for="woocommerce-product-search-field-0">Ara:</label>
                                                                                                                        <input type="search"
                                                ...
                                                <ul
                                                                                                ...
                                                                                                <form role="search"
                                                                                                        ...
                                                                                                        <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                        class="flex-col flex-grow">
                                                                                                                        <label class="screen-reader-text"
                                                                                                                                for="woocommerce-product-search-field-1">Ara:</label>
                                                                                                                        <input type="search"
                                                        ...
                                                        <li id="menu-item-18902"
                                                                ...
                                                                <RouterLink to="/contactUs"
                                                                        class="nav-top-link">Bize Ulaşın</RouterLink></li>
                                                </ul>
                                        </div>
                                                ...
                                                <ul
                                                        ...
                                                        <li class="html header-social-icons ml-0">
                                                                <div class="social-icons follow-icons"><a
                                                                                ...
                                                                                aria-label="Facebook' ta Takip Edin"><i
                                                                                ...
                                                                                aria-label="Instagram' da Takip Edin"><i
                                                                                ...
                                                                                aria-label="Twitter' da Takip Edin"><i
                                                                                        class="icon-twitter"></i></a>
                                                                </div>
                                                        </li>
                                                        <li class="account-item has-icon">
                                                                <RouterLink  class="nav-top-link nav-top-not-logged-in" to="/login">
                                                                        <span> Giriş Yap </span>
                                                                </RouterLink>
                                                        </li>
                                        ...
                                        <div class="flex-col show-for-medium flex-right">
                                                <ul class="mobile-nav nav nav-right ">
                                                        <li class="cart-item has-icon"><a
                                                                ...
                                                                <div id="cart-popup"
                                                                        class="mfp-hide widget_shopping_cart">
                                                                        <div class="cart-popup-inner inner-padding">
                                                                                ...
                                                                                <div
                                                                                        class="cart-sidebar-content relative">
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                        </li>
